...
public class TaxPayer {
    ...
    public double salaryTax(){
        if (this.salaryIncome < 36000){
            return 0;
        } else if (this.salaryIncome >= 36000 && this.salaryIncome <= 60000) {
    ...
    public double taxRebate(){
        ...
        double gastosDetutiveis = this.healthSpending + this.educationSpending;

        return Math.min(maximoDedutivel, gastosDetutiveis);
    }
